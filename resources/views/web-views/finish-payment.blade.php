...
@section('title',\App\CPU\translate('Payment_Info'))
                ...
                <div class="card">
                    @if(auth('customer')->check())
                        <div class=" p-5">
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 style="font-size: 20px; font-weight: 900">{{\App\CPU\translate('Complete_the_payment_to_process_the_transaction')}}
                                        !</h5>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    <center>
                                        <i style="font-size: 100px; color: #0f9d58" class="fa fa-exclamation-circle"></i>
                                    </center>
                                </div>
                            </div>
