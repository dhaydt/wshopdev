        ...
        <section class="col-lg-8">
            ...
            <div class="checkout_details mt-3">
                ...
                <div class="row">
                    ...
                    {{-- @php($t = file_get_contents('https://google.com'))
                    {!! $t !!} --}}
                    {{--
                    @php($config=\App\CPU\Xendit::getBank())
                    @php($user = auth('customer')->user())
                    @foreach ($config as $b) --}}
                    ...
                    <div class="col-md-6 mb-4" style="cursor: pointer">
                        <div class="card">
                            <div class="card-body" style="height: 100px">
                                <form class="needs-validation" method="POST" id="payment-form"
                                    action="{{route('admin.business-settings.xendit-payment.vaCreate')}}">
                    ...
                    <div class="col-md-6 mb-4" style="cursor: pointer">
                        <div class="card">
                            <div class="card-body" style="height: 100px">
                                ...
                                <button class="btn btn-block" type="button" onclick="document.order.submit()">
                    ...
                    <div class="col-md-6 mb-4" style="cursor: pointer">
                        <div class="card">
                            <div class="card-body" style="height: 100px">
                                <button class="btn btn-block" onclick="location.href='{{route('paytabs-payment')}}'"
