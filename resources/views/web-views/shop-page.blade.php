...
<div class="container pb-5 mb-2 mb-md-4">
    <div class="row rtl">
        ...
        <div class="col-lg-12 mt-2">
            <div style="background: white">
                ...
                <img style="width:100%; height: auto; max-height: 13.75rem; border-radius: 3px;" src="{{asset("
                    storage/app/public/shop")}}/{{$banner??""}}"
                    onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'" alt="">
                @endif
            </div>
        </div>
        {{-- sidebar opener --}}
        <div class="col-md-3 mt-2 rtl" style=" width: 100%; text-align: {{Session::get('direction') === " rtl" ? 'right'
            : 'left' }};">
            <a class="openbtn-tab" style="" onclick="openNav()">
                <div style="font-size: 20px; font-weight: 600; text-align: {{Session::get('direction') === " rtl"
                    ? 'right' : 'left' }}" class="for-tab-display"> ☰ {{\App\CPU\translate('categories')}}</div>
            </a>
        </div>
        {{-- seller info+contact --}}
                        ...
                        <div class="row col-8 mx-1" style="display:inline-block;">
                            ...
                            <div class="row ml-4 flex-start">
                                <div class="mr-3">
                                    ...
                                    @for($count=0; $count<5; $count++) @if($avg_rating>= $count+1)
    ...
    <div class="row mt-2 mr-0 rtl">
        ...
        <div id="mySidepanel" class="sidepanel" style="text-align: {{Session::get('direction') === " rtl"
            ? 'right:0; left:auto' : 'right:auto; left:0' }};">
